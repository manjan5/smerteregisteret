...
Denne tabellen viser hvor mange som har fått tilsyn av de ulike behandlergruppene per måned. I tillegg vises antall pasienttilsyn og totalt antall behandlertilsyn. Antall pasienter er antall unike pasienter. Antall henvisninger viser antall forløp som er registert (altså uavhenging av om samme pasient er henvist flere ganger i løpet av perioden).
...
tilsyn_full = dat %>% select(AntPasTils, AntTilsLege, AntTilsSykPleier, AntTilsFysioT, AntTilsPsyk, AntTilsSosio, RegDato11, PasientID, ForlopsID) %>% 
...
antall_pas_maned = tilsyn_full %>% distinct(PasientID, .keep_all = TRUE) %>% count(monthname) 
